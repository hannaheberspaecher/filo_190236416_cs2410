    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('home') }}"><b>Find-the-Lost</b></a>
                    ...
                    <ul class="navbar-nav mr-auto">
                      <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          ...
                          <a class="dropdown-item" href="{{ route('pet') }}">Pet</a>
                      ...
                      @guest
                      <li class="nav-item">
                      <a class="nav-link disabled" href="#">Add Item</a>
                      </li>
                      @else
                      <li class="nav-item">
                      ...
                      @if (Gate::allows('admin'))
                        <li class="nav-item">
                          <a class="nav-link" href="{{ route('requested_items') }}">Requests</a>
                        </li>
                      @endif
